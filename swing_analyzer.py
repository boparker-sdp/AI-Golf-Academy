...
def analyze_foundation_sequence(video_path):
    """FACE-ON: Focuses on Body Stability, Hip-Shoulder Stretch, and Timing."""
    ...
    with mp_pose.Pose(min_detection_confidence=0.5) as pose:
        while cap.isOpened():
            ...
            if res.pose_landmarks:
                ...
                # Overlays
                cv2.putText(frame, f"STRETCH: {stretch}", (50, int(h*0.1)), 2, fs*1.2, (255, 0, 255), thick)
...
def analyze_swing_plane(video_path):
    ...
    with mp_pose.Pose(min_detection_confidence=0.7, min_tracking_confidence=0.7) as pose:
        while cap.isOpened():
            ...
            if results.pose_landmarks:
                ...
                cv2.putText(frame, f"HINGE: {ang}deg", (curr_re[0]+30, curr_re[1]), 2, fs, (0,255,255), thick)
    ...
    return f"### 🏌️ Swing Plane Lab\nTop Hinge: {lag_top}° | Impact Hinge: {lag_impact}°", web_path
